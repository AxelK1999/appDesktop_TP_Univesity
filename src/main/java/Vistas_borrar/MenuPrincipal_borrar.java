...
public class MenuPrincipal_borrar extends javax.swing.JFrame {
	...
	public MenuPrincipal_borrar(ControladorProyectosLote CP,ControladorCampo CC, ControladorCultivos CCultivos,ControladorLote controladorLote) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administraci�n de Campos");
        ...
        jLabel3.setText("�Qu� desea administrar?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrincipal_borrar().setVisible(true);
            }
        });
    }
    */
